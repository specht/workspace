...
cp src/sidebar-init/hackschule-sidebar-init-0.0.1.vsix docker/code/hackschule-sidebar-init-0.1.0.vsix
cp src/checkpoints/hackschule-checkpoints-0.5.0.vsix docker/code/hackschule-checkpoints-0.5.0.vsix
